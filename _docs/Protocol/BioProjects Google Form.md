...
| **Paper_Availability** | Indication of whether an associated published paper can be linked to the BioProject. | Indicate if an associated published paper is available for the BioProject: <br>if a published paper is available, mark TRUE.</br> <br>if a published paper is *not* available, mark FALSE</br>|
